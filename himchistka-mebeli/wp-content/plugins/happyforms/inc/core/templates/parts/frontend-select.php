		...
		<div class="happyforms-part__el">
			...
			<div class="happyforms-custom-select">
				<div class="happyforms-part__select-wrap">
					...
					<input id="<?php happyforms_the_part_id( $part, $form ); ?>" type="text" value="<?php echo $default_label; ?>" placeholder="<?php echo $placeholder_text; ?>"<?php if ( 1 === $part['required'] ) : ?> required aria-required="true"<?php endif; ?> data-searchable="<?php echo ( 1 == $part['allow_search'] ) ? 'true' : 'false'; ?>" autocomplete="off" <?php happyforms_the_part_attributes( $part, $form ); ?> />
